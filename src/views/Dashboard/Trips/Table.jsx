...
export const Table = ({
  ...
  return (
    <>
      <ContainerTabla>
        {/* Aqui se dividen entre 100 la cantidad de columnas que tendra la tabla 
        para que se ajuste de manera variable al contenido */}
        <StyledTable maxwidth={"12.3%"} minwidth={"12.3%"} width={"12.3%"}>
          <thead>
            <tr>
              {tHeader.map((item, i) => {
                return (
