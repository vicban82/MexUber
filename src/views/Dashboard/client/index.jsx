...
import { axiosGetClient, axiosSearchClient } from "../../../hooks/client/crudClient";
...
export const Client = () => {
  ...
  useEffect(() => {
    if (searchTerm) {
      axiosSearchClient(searchTerm, setTDriver, setTotalPages, headers, page, limit);
    } else {
      axiosGetClient(setTDriver, setTotalPages, headers, page, limit);
    }
